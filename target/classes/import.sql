...
INSERT INTO tb_user (first_name, last_name, email, password) VALUES ('Joao', 'Paulo', 'joao8000paulo@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
...
INSERT INTO tb_course (name, img_Uri, img_Gray_Uri) VALUES ('Java', 'www.google.com', 'oi.com/gray');
INSERT INTO tb_course (name, img_Uri, img_Gray_Uri) VALUES ('C++', 'www.google.com', 'C++.com/gray');

INSERT INTO tb_offer (edition, start_Moment, end_Moment, course_id) VALUES ('1.0', TIMESTAMP WITH TIME ZONE '2022-07-25T13:00:00Z', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', 1);
INSERT INTO tb_offer (edition, start_Moment, end_Moment, course_id) VALUES ('3.0', TIMESTAMP WITH TIME ZONE '2023-07-25T13:00:00Z', TIMESTAMP WITH TIME ZONE '2025-07-25T13:00:00Z', 1);

INSERT INTO tb_resource (title, description, position, img_Uri, type, offer_id) VALUES ('Spring', 'Course to learn Java with Spring', 1, 'www.goole.com/spring/images', 2, 2);

INSERT INTO tb_enrollment (user_id, offer_id, enroll_Moment, refund_Moment, available, only_Update) VALUES (1, 1, TIMESTAMP WITH TIME ZONE '2022-07-25T13:00:00Z', TIMESTAMP WITH TIME ZONE '2022-10-25T13:00:00Z', true, true);
INSERT INTO tb_enrollment (user_id, offer_id, enroll_Moment, refund_Moment, available, only_Update) VALUES (2, 1, TIMESTAMP WITH TIME ZONE '2022-07-25T13:00:00Z', TIMESTAMP WITH TIME ZONE '2022-11-25T13:00:00Z', true, true);
 

INSERT INTO tb_section (title, description, position, img_Uri, resource_id, prerequisite_id) VALUES ('a', 'b', 1, 'ca', 1, null);
INSERT INTO tb_section (title, description, position, img_Uri, resource_id, prerequisite_id) VALUES ('a', 'b', 1, 'ca', 1, null);
INSERT INTO tb_section (title, description, position, img_Uri, resource_id, prerequisite_id) VALUES ('a', 'b', 1, 'ca', 1, null);



INSERT INTO tb_lesson (title, position, section_id) VALUES ('Lesson 1 of the chapter 1', 1, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (1, 'Introduction', 'https://music.youtube.com/watch?1');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Lesson 2 of the chapter 1', 2, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (2, 'Suport material', 'https://music.youtube.com/watch?2');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Lesson 3 of the chapter 1', 3, 1);
INSERT INTO tb_content (id, text_Content, video_Uri) VALUES (3, 'Hello World!', 'https://music.youtube.com/watch?3');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('Lesson 4 of the chapter 1', 4, 1);
INSERT INTO tb_task (id, description, question_Count, approval_Count, weight, due_Date) VALUES (1, 'Task to deliver', 5, 4, 1.0, TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z');

INSERT INTO tb_topic (title, body, moment, author_id, offer_id, lesson_id) VALUES ('bbbbbaaaaa', 'I understood everthing, but...', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', 2, 1, 3);
INSERT INTO tb_topic (title, body, moment, author_id, offer_id, lesson_id) VALUES ('ccccddddddd', 'Fine! but id dont speak english', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', 3, 1, 3);
INSERT INTO tb_topic (title, body, moment, author_id, offer_id, lesson_id) VALUES ('eeefffffffff', 'Cannot print', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', 2, 1, 3);
INSERT INTO tb_topic (title, body, moment, author_id, offer_id, lesson_id) VALUES ('ggghhhh', 'How to edit material in Adobe?', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', 3 , 1, 2);


INSERT INTO tb_topic_likes (topic_id, user_id) VALUES (1 ,1); 
INSERT INTO tb_topic_likes (topic_id, user_id) VALUES (4 ,1);
INSERT INTO tb_topic_likes (topic_id, user_id) VALUES (2 ,1);
INSERT INTO tb_topic_likes (topic_id, user_id) VALUES (3 ,3);
INSERT INTO tb_topic_likes (topic_id, user_id) VALUES (3 ,1);


INSERT INTO tb_deliver (uri, moment, status, feedback, correct_Count, lesson_id, user_id, offer_id) VALUES ('...', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', 1, 'Good, but could be better', 4, 1, 1, 1);

INSERT INTO tb_lessons_done (user_id, offer_id, lesson_id) VALUES (1, 1, 1);

INSERT INTO tb_notification (text, moment, read, route, user_id) VALUES ('You have one day to get ready', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', true, 'not know', 1);
INSERT INTO tb_notification (text, moment, read, route, user_id) VALUES ('You have two days to get ready', TIMESTAMP WITH TIME ZONE '2024-07-25T13:00:00Z', false, 'not know', 2);
